...
knitr::opts_chunk$set(echo = FALSE,messages = FALSE, error = FALSE)
```
...
```{r}
ggplot(monthly_totals) + geom_col(aes(x=Month,y=Total,fill=country)) +
  scale_y_continuous(label =comma ) + labs(title = " MonthlyTotals by Country")

ggplot(monthly_totals) + geom_col(aes(x=Month,y=Mean,fill=country)) +
  scale_y_continuous(label =comma ) + labs(title = "Month Means by Country")

ggplot(monthly_totals) + geom_col(aes(x=Month,y=Median,fill=country)) +
  scale_y_continuous(label =comma ) + labs(title = "Monthly Median by Country")

ggplot(monthly_totals) + geom_col(aes(x=Month,y=Percent,fill=country)) +
